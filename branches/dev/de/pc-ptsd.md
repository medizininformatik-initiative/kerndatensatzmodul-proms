# PC-PTSD - MII IG PRO v2027.0.0-ballot.rc3
...
1. **Observation**mit MII-Score-Code`pc-ptsd-total`
1. **ObservationDefinition:**`mii-obsdef-pro-score-pc-ptsd`— Wertebereich 0–4 {score}, höher = stärkerer Verdacht auf eine posttraumatische Belastungsstörung

Der Cut-off ist als `qualifiedInterval` **dokumentiert**, nicht als ausführbare Interpretationslogik (siehe [Scoring](scoring.md)).
