# MII PR PRO Score Instance - MII IG PRO v2027.0.0-ballot.rc5
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/StructureDefinition/mii-pr-pro-score-instance | *Version*:2027.0.0-ballot.rc5 |
| Active Stand: 2026-09-11 | *Maschinenlesbarer Name*:MII_PR_PRO_Score_Instance |
...
**Beispiel** — eine konkrete Score-Observation, die von diesem abstrakten Profil erbt: [PHQ-9-Score](Observation-mii-exa-pro-phq-9-observation.md).
...
* [http://hl7.org/fhir/StructureDefinition/workflow-instantiatesCanonical](http://hl7.org/fhir/extensions/5.3.0/StructureDefinition-workflow-instantiatesCanonical.html)
