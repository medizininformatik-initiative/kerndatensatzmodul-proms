# MII QST PRO ISR-Z - MII IG PRO v2027.0.0-ballot.rc4

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII QST PRO ISR-Z**

## Questionnaire: MII QST PRO ISR-Z (Experimentell) 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/Questionnaire/mii-qst-pro-isr-z | *Version*:2027.0.0-ballot.rc4 |
| Active Stand: 2026-09-10 | *Maschinenlesbarer Name*: |
| **Copyright/Rechtliches**: ICD-10-Symptom-Rating (ISR) © Tritt, von Heymann, Zaudig, Zacharias, Söllner & Loew 2008. Freely available — no permission required for reproduction, translation, display or use. Lizenz-Status: frei verfügbar (Tier A). | |
...
```json
{
  ...
  },
  {
    ...
    "valueExpression" : {
      ...
      "expression" : "%resource.item.where(linkId.matches('^isr-z-q0[1-3]$')).answer.value.weight().avg()"
    }
  }],
