# EORTC QLQ-C30 Insomnia Score - MII IG PRO v2027.0.0-ballot.rc3

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **EORTC QLQ-C30 Insomnia Score**

## Beispiel Observation: EORTC QLQ-C30 Insomnia Score
...
**code**: EORTC QLQ-C30 Insomnia Score
...
**value**: 33.33 {score} (Details: UCUM code{score} = '{score}')
