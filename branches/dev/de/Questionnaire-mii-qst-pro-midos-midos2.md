# MII QST PRO MIDOS2 - MII IG PRO v2027.0.0-ballot.rc4

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII QST PRO MIDOS2**

## Questionnaire: MII QST PRO MIDOS2 (Experimentell) 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/Questionnaire/mii-qst-pro-midos-midos2 | *Version*:2027.0.0-ballot.rc4 |
| Draft Stand: 2026-09-10 | *Maschinenlesbarer Name*:MII_QST_PRO_MIDOS_MIDOS2 |
...
```json
{
  ...
  },
  {
    ...
    "valueExpression" : {
      ...
      "expression" : "%resource.item.where(linkId.matches('^midos2-q(0[1-9]|1[01])-')).answer.value.weight().sum()"
    }
  }],
