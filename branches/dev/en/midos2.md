# MIDOS2 - MII IG PRO v2027.0.0-ballot.rc2
...
MIDOS2 and the [PRO-CTCAE Oncology Base Screening](proms-onkologisches-basisscreening.md) conceptually represent **the same symptom list** — at differing granularity of the response scales:
...
The complete resource is in the [Questionnaire definition](Questionnaire-mii-qst-pro-midos-midos2.md).
...
The complete resource is in the [CodeSystem definition](CodeSystem-mii-cs-pro-midos2.md).
