# MII QST PRO SSD-12 - MII IG PRO v2027.0.0-ballot.rc4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII QST PRO SSD-12**

## Questionnaire: MII QST PRO SSD-12 (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/Questionnaire/mii-qst-pro-ssd-12 | *Version*:2027.0.0-ballot.rc4 |
...
```json
{
  ...
  },
  {
    ...
    "valueExpression" : {
      ...
      "expression" : "%resource.item.where(linkId.matches('^ssd12-q(0[1-9]|1[0-2])$')).answer.value.weight().sum()"
    }
  }],
