# MII PR PRO Depression Domain T-Score - MII IG PRO v2027.0.0-ballot.rc5

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR PRO Depression Domain T-Score**

## Resource Profile: MII PR PRO Depression Domain T-Score 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/StructureDefinition/mii-pr-pro-depression-t-score | *Version*:2027.0.0-ballot.rc5 |
| Active as of 2026-09-11 | *Computable Name*:MII_PR_PRO_Depression_T_Score |
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-pro-depression-t-score.csv), [Excel](../StructureDefinition-mii-pr-pro-depression-t-score.xlsx), [Schematron](../StructureDefinition-mii-pr-pro-depression-t-score.sch) 
