# ID Systematics - MII IG PRO v2027.0.0-ballot.rc1
...
1. **Fragengruppen-Identifikation**: Kennzeichnung von Item-Blöcken/Domänen (z.B. PROMIS-29 Physical Function 4a)
1. **Item-Identifikation**: Eindeutige Kennzeichnung einzelner Fragen (z.B. EQ-5D-5L Mobility)
1. **Antwortoptionen-Identifikation**: Kennzeichnung spezifischer Auswahlmöglichkeiten (z.B. "0: Keine Schmerzen")
1. **Score-Identifikation**: Eindeutige Kennzeichnung von Score-Definitionen (z.B. EQ-5D-VAS-Score)
1. **Domänen-Identifikation**: Kennzeichnung gesundheitsbezogener Domänen (z.B. Depression, Angst)
...
1. **Verschiedene Major-Versionen**eines Fragebogens (z.B. BDI vs. BDI-II)
1. **Parent-Proxy-Versionen**für Eltern/Kinder-Assessments
1. **Altersgerechte Varianten**in der Pädiatrie
1. **Sprachvarianten**mit inhaltlichen Unterschieden zwischen den Sprachen
...
1. **Bindestriche**: Trennung von Komponenten durch Bindestriche (keine Unterstriche)
1. **Präfix-Konsistenz**: Gleicher Instrument-Präfix für alle Items eines Fragebogens
1. **Führende Nullen**: Nummerierung immer zweistellig (q01, q02, …, q10, q11, …)
1. **Eindeutigkeit**: LinkIds müssen innerhalb eines Fragebogens eindeutig sein
1. **Menschenlesbarkeit**: IDs sollten für Entwickler und Kliniker verständlich sein
...
1. **Konsistente Präfixe**: Orientiere dich an bestehenden Namespace-Konventionen
1. **Führende Nullen**: Verwende immer zweistellige Nummerierung (q01-q99)
1. **Domain-Codes**: Ergänze bei strukturierten Instrumenten Domain-Abkürzungen
1. **Score-Suffix**: Verwende klare Score-Bezeichnungen (-score-total, -score-raw, etc.)
...
**Detaillierte Dokumentation**: [Terminologie-Strategien](terminology-strategies.md)
