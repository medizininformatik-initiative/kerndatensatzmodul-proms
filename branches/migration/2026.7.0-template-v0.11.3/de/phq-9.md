# PHQ-9 - MII IG PRO v2027.0.0-ballot.rc1
...
Die vollständige Ressource finden Sie in der [Questionnaire-Definition](Questionnaire-mii-qst-pro-phq-9.md).
...
1. **Als Observation**mit LOINC-Code 44261-6 "PHQ-9 total score"
1. **Als Domain-Score**gemappt auf PROMIS Depression T-Score
...
Das vollständige Beispiel finden Sie unter [QuestionnaireResponse](QuestionnaireResponse-mii-exa-pro-phq-9-response.md).
