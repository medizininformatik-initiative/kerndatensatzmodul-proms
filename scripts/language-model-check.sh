...
ALLOW='.claude/skills/extract-qst-translations/extract-de.sh|German source PDFs
...
migration-log/preflight-analysis.json|input/translations/en
migration-log/run.log|input/translations/en/pagecontent
migration-log/run.log|the 12 written English pages
migration-log/sushi-config.source.yaml|input/translations/en'
