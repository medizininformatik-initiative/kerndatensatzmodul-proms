# WHODAS 2.0 12-Item Simple Sum Score Observation - MII IG PRO v2026.5.1
...
Profile: [MII PR PRO Observation WHODAS 2.0 12-Item](StructureDefinition-mii-pr-pro-observation-whodas12.md) version: 2026.5.1
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/StructureDefinition/mii-pr-pro-observation-whodas12|2026.5.1"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
