# PHQ-15 Score Observation Example - MII IG PRO v2026.5.1
...
Profile: [MII PR PRO Observation PHQ-15](StructureDefinition-mii-pr-pro-observation-phq-15.md) version: 2026.5.1
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/StructureDefinition/mii-pr-pro-observation-phq-15|2026.5.1"]
  },
  "status" : "final",
  "code" : {
    "coding" : [{
