# MII PR PRO PROMIS-29 Fatigue T-Score - MII IG PRO v2027.0.0-ballot.rc3

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR PRO PROMIS-29 Fatigue T-Score**

## Resource Profile: MII PR PRO PROMIS-29 Fatigue T-Score ( Experimental ) 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/StructureDefinition/mii-pr-pro-promis-29-fatigue-tscore | *Version*:2027.0.0-ballot.rc3 |
| Active as of 2026-09-07 | *Computable Name*:MII_PR_PRO_PROMIS_29_Fatigue_TScore |

 
Profile for PROMIS-29 Fatigue T-Score Observations 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.pros|current/StructureDefinition/StructureDefinition-mii-pr-pro-promis-29-fatigue-tscore.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-pro-promis-29-fatigue-tscore.csv), [Excel](../StructureDefinition-mii-pr-pro-promis-29-fatigue-tscore.xlsx), [Schematron](../StructureDefinition-mii-pr-pro-promis-29-fatigue-tscore.sch) 
