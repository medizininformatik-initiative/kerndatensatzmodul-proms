# MII PR PRO PROMIS Cognitive Function SF 4a T-Score - MII IG PRO v2027.0.0-ballot.rc3

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR PRO PROMIS Cognitive Function SF 4a T-Score**

## Resource Profile: MII PR PRO PROMIS Cognitive Function SF 4a T-Score ( Experimental ) 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/StructureDefinition/mii-pr-pro-promis-cognitive-function-sf4a-tscore | *Version*:2027.0.0-ballot.rc3 |
| Active as of 2026-09-07 | *Computable Name*:MII_PR_PRO_PROMIS_Cognitive_Function_SF4a_TScore |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.pros|current/StructureDefinition/StructureDefinition-mii-pr-pro-promis-cognitive-function-sf4a-tscore.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-pro-promis-cognitive-function-sf4a-tscore.csv), [Excel](../StructureDefinition-mii-pr-pro-promis-cognitive-function-sf4a-tscore.xlsx), [Schematron](../StructureDefinition-mii-pr-pro-promis-cognitive-function-sf4a-tscore.sch) 
