# MII PR PRO Observation PHQ-9 - MII IG PRO v2027.0.0-ballot.rc3

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR PRO Observation PHQ-9**

## Ressourcenprofil: MII PR PRO Observation PHQ-9 ( Experimentell ) 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/StructureDefinition/mii-pr-pro-observation-phq-9 | *Version*:2027.0.0-ballot.rc3 |
| Active Stand: 2026-09-07 | *Maschinenlesbarer Name*:MII_PR_PRO_Observation_PHQ_9 |
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-pro-observation-phq-9.csv), [Excel](../StructureDefinition-mii-pr-pro-observation-phq-9.xlsx), [Schematron](../StructureDefinition-mii-pr-pro-observation-phq-9.sch) 
