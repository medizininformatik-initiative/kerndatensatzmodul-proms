# MII CS PRO Questionnaire Catalogue - MII IG PRO v2027.0.0-ballot.rc3

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII CS PRO Questionnaire Catalogue**

## CodeSystem: MII CS PRO Questionnaire Catalogue 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/CodeSystem/mii-cs-pro-questionnaire-catalogue | *Version*:2027.0.0-ballot.rc3 |
| Active Stand: 2026-09-07 | *Maschinenlesbarer Name*:MII_CS_PRO_Questionnaire_Catalogue |
...
```json
{
  ...
  {
    "code" : "proctcae",
    "display" : "PRO-CTCAE (Patient-Reported Outcomes version of the Common Terminology Criteria for Adverse Events)"
  },
  {
