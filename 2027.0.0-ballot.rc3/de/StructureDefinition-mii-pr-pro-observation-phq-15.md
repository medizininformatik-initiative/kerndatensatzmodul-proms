# MII PR PRO Observation PHQ-15 - MII IG PRO v2027.0.0-ballot.rc3

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR PRO Observation PHQ-15**

## Ressourcenprofil: MII PR PRO Observation PHQ-15 ( Experimentell ) 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/StructureDefinition/mii-pr-pro-observation-phq-15 | *Version*:2027.0.0-ballot.rc3 |
| Active Stand: 2026-09-07 | *Maschinenlesbarer Name*:MII_PR_PRO_Observation_PHQ_15 |
...
* Examples for this Profile: [Observation/mii-exa-pro-phq-15-observation](Observation-mii-exa-pro-phq-15-observation.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.pros|current/StructureDefinition/StructureDefinition-mii-pr-pro-observation-phq-15.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-pro-observation-phq-15.csv), [Excel](../StructureDefinition-mii-pr-pro-observation-phq-15.xlsx), [Schematron](../StructureDefinition-mii-pr-pro-observation-phq-15.sch) 
