# MII PR PRO Observation EQ-5D-5L Index - MII IG PRO v2027.0.0-ballot.rc3

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR PRO Observation EQ-5D-5L Index**

## Ressourcenprofil: MII PR PRO Observation EQ-5D-5L Index ( Experimentell ) 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/StructureDefinition/mii-pr-pro-observation-eq5d5l-index | *Version*:2027.0.0-ballot.rc3 |
| Active Stand: 2026-09-07 | *Maschinenlesbarer Name*:MII_PR_PRO_Observation_EQ5D5L_Index |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.pros|current/StructureDefinition/StructureDefinition-mii-pr-pro-observation-eq5d5l-index.json)
...
* The element 1 is sliced based on the value of Observation.note
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-pro-observation-eq5d5l-index.csv), [Excel](../StructureDefinition-mii-pr-pro-observation-eq5d5l-index.xlsx), [Schematron](../StructureDefinition-mii-pr-pro-observation-eq5d5l-index.sch) 
