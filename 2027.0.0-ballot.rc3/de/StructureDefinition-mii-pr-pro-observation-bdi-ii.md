# MII PR PRO Observation BDI-II - MII IG PRO v2027.0.0-ballot.rc3

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR PRO Observation BDI-II**

## Ressourcenprofil: MII PR PRO Observation BDI-II ( Experimentell ) 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/StructureDefinition/mii-pr-pro-observation-bdi-ii | *Version*:2027.0.0-ballot.rc3 |
| Active Stand: 2026-09-07 | *Maschinenlesbarer Name*:MII_PR_PRO_Observation_BDI_II |
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-pro-observation-bdi-ii.csv), [Excel](../StructureDefinition-mii-pr-pro-observation-bdi-ii.xlsx), [Schematron](../StructureDefinition-mii-pr-pro-observation-bdi-ii.sch) 
