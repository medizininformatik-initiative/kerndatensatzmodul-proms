# MII PR PRO PROMIS-29 Depression T-Score - MII IG PRO v2027.0.0-ballot.rc3

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR PRO PROMIS-29 Depression T-Score**

## Ressourcenprofil: MII PR PRO PROMIS-29 Depression T-Score ( Experimentell ) 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/StructureDefinition/mii-pr-pro-promis-29-depression-tscore | *Version*:2027.0.0-ballot.rc3 |
| Active Stand: 2026-09-07 | *Maschinenlesbarer Name*:MII_PR_PRO_PROMIS_29_Depression_TScore |

 
Profile for PROMIS-29 Depression T-Score Observations 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.pros|current/StructureDefinition/StructureDefinition-mii-pr-pro-promis-29-depression-tscore.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-pro-promis-29-depression-tscore.csv), [Excel](../StructureDefinition-mii-pr-pro-promis-29-depression-tscore.xlsx), [Schematron](../StructureDefinition-mii-pr-pro-promis-29-depression-tscore.sch) 
