# MII PR PRO Score Blueprint / Template - MII IG PRO v2027.0.0-ballot.rc3
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/StructureDefinition/mii-pr-pro-score-blueprint | *Version*:2027.0.0-ballot.rc3 |
| Active Stand: 2026-09-07 | *Maschinenlesbarer Name*:MII_PR_PRO_Score_Blueprint |
...
**Beispiel** — eine konkrete Score-Definition, die dieses abstrakte Profil erweitert: [BDI-II-Score-Definition](ObservationDefinition-mii-obsdef-pro-score-bdi-ii.md).
