# EORTC QLQ-C30 Pain Score - MII IG PRO v2027.0.0-ballot.rc3

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **EORTC QLQ-C30 Pain Score**

## Example Observation: EORTC QLQ-C30 Pain Score
...
**value**: 16.67 {score} (Details: UCUM code{score} = '{score}')
