...
Die vollständige Ressource: [Questionnaire-Definition](Questionnaire-mii-qst-pro-isr-z.html).

#### Score-Repräsentation

1. **Berechnetes Item** in der QuestionnaireResponse (linkId: `isr-z-score-mean`)
2. **Observation** mit MII-Score-Code `isr-z-mean`
3. **ObservationDefinition:** `mii-obsdef-pro-score-isr-z` — Wertebereich 0–4 {score} als **Dezimalwert** (Mittelwert, daher keine Ganzzahl), höher = stärker ausgeprägte Zwangssymptomatik
