...
Die vollständige Ressource: [Questionnaire-Definition](Questionnaire-mii-qst-pro-scoff.html).
...
Der Cut-off ≥ 2 ist als `qualifiedInterval` **dokumentiert**, aber bewusst nicht als ausführbare Interpretationslogik ausgeliefert (siehe [Scoring](scoring.html)).
