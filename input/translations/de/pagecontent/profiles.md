...
|--------|--------------|-------|-------------|
| [MII_PR_PRO_Questionnaire](StructureDefinition-mii-pr-pro-questionnaire.html) | Questionnaire | SDC Questionnaire | Grundlage für alle PRO-Fragebögen |
| [MII_PR_PRO_QuestionnaireResponse](StructureDefinition-mii-pr-pro-questionnaire-response.html) | QuestionnaireResponse | SDC QuestionnaireResponse | Struktur ausgefüllter Fragebögen |
| [MII_PR_PRO_Score_Blueprint](StructureDefinition-mii-pr-pro-score-blueprint.html) | ObservationDefinition | FHIR R4 | Vorlagen für PRO-Score-Definitionen |
| [MII_PR_PRO_Score_Instance](StructureDefinition-mii-pr-pro-score-instance.html) | Observation | FHIR R4 | Konkrete Score-Observations |

### Vererbungshierarchie

Die abstrakten Profile bilden die Basis einer klaren Vererbungshierarchie:

![Abstrakte Profile Vererbungshierarchie](Abstract_Profiles.png)
