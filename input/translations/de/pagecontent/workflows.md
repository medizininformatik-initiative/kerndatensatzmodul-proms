...
{% include img.html img="Workflow_Standard.svg" caption="MII PRO Workflow-Pattern: Standard" width="40%" %}
</div>
...
<div style="text-align: center;">
{% include img.html img="Workflow_Capability-Echtzeit.svg" caption="MII PRO Workflow-Pattern: Capability-basierte Variante, Echtzeit-Berechnung" width="40%" %}
</div>
...
<div style="text-align: center;">
{% include img.html img="Workflow_Capability-Server.svg" caption="MII PRO Workflow-Pattern: Capability-basierte Variante, Server-Berechnung" width="50%" %}
</div>
...
<div style="text-align: center;">
{% include img.html img="Workflow_Capability-Historisch.svg" caption="MII PRO Workflow-Pattern: Capability-basierte Variante, Historische Neuberechnung" width="40%" %}
</div>
...
<div style="text-align: center;">
{% include img.html img="Workflow_Score_Repraesentation.svg" caption="MII PRO Workflow-Pattern: Score Repräsentationsebenen" width="60%" %}
</div>
...
<div style="text-align: center;">
{% include img.html img="Workflow_Domain_Mapping.svg" caption="MII PRO Domain Mapping-Patterns" width="30%" %}
</div>
