...
* item[=].text = "BEWEGLICHKEIT / MOBILITÄT"
* item[=].answer[0].valueCoding = $mii-cs-pro-eq-5d-value-set#MO-3 "Ich habe mäßige Probleme herumzugehen"
...
* item[=].text = "FÜR SICH SELBST SORGEN"
* item[=].answer[0].valueCoding = $mii-cs-pro-eq-5d-value-set#SC-2 "Ich habe leichte Probleme, mich selbst zu waschen oder anzuziehen"
...
* item[=].text = "ALLTÄGLICHE TÄTIGKEITEN (z.B. Arbeit, Studium, Hausarbeit, Familien- / Freizeitaktivitäten)"
* item[=].answer[0].valueCoding = $mii-cs-pro-eq-5d-value-set#UA-4 "Ich habe große Probleme, meinen alltäglichen Tätigkeiten nachzugehen"
...
* item[=].text = "SCHMERZEN / KÖRPERLICHEN BESCHWERDEN"
* item[=].answer[0].valueCoding = $mii-cs-pro-eq-5d-value-set#PD-3 "Ich habe mäßige Schmerzen oder Beschwerden"
...
* item[=].text = "ANGST / NIEDERGESCHLAGENHEIT"
* item[=].answer[0].valueCoding = $mii-cs-pro-eq-5d-value-set#AD-1 "Ich bin nicht ängstlich oder deprimiert"
