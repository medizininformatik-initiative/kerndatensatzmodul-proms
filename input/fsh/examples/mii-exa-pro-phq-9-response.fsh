...
* item[=].answer[0].valueCoding = $LNC#LA6571-9 "Beinahe jeden Tag" // Nearly every day (3)
...
* item[=].answer[0].valueCoding = $LNC#LA6574-3 "Sehr stark erschwert" // Extremely difficult (not scored)