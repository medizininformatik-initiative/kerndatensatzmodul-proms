...
* item[0].answer[0].valueCoding = $LNC#LA6571-9
* item[1].linkId = "phq-phq9-q02"
* item[1].answer[0].valueCoding = $LNC#LA6571-9
* item[2].linkId = "phq-phq9-q03"
* item[2].answer[0].valueCoding = $LNC#LA6571-9
* item[3].linkId = "phq-phq9-q04"
* item[3].answer[0].valueCoding = $LNC#LA6571-9
* item[4].linkId = "phq-phq9-q05"
* item[4].answer[0].valueCoding = $LNC#LA6571-9
* item[5].linkId = "phq-phq9-q06"
* item[5].answer[0].valueCoding = $LNC#LA6571-9
* item[6].linkId = "phq-phq9-q07"
* item[6].answer[0].valueCoding = $LNC#LA6571-9
* item[7].linkId = "phq-phq9-q0"
* item[7].answer[0].valueCoding = $LNC#LA6571-9
* item[8].linkId = "phq-phq9-q09"
* item[8].answer[0].valueCoding = $LNC#LA6571-9
* item[9].linkId = "phq-phq9-q10"
* item[9].answer[0].valueCoding = $LNC#LA6574-3
