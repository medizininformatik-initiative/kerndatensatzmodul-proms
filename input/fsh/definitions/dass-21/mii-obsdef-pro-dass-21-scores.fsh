...
Title: "DASS-21 Depression Raw Score"
...
InstanceOf: mii-pr-pro-score-blueprint
Title: "DASS-21 Anxiety Raw Score"
...
InstanceOf: mii-pr-pro-score-blueprint
Title: "DASS-21 Stress Raw Score"
...
InstanceOf: mii-pr-pro-score-blueprint
Title: "DASS-21 Depression Score (DASS-42 Equivalent)"
...
* qualifiedInterval.range.extension[ScoreHealthCorrelation].valueCodeableConcept.coding = http://terminology.hl7.org/CodeSystem/measure-improvement-notation#decrease
* qualifiedInterval.range.extension[ScoreHealthCorrelation].valueCodeableConcept.text = "Higher score indicates worse depression severity (DASS-42 equivalent = DASS-21 raw x 2)"
...
InstanceOf: mii-pr-pro-score-blueprint
Title: "DASS-21 Anxiety Score (DASS-42 Equivalent)"
...
* qualifiedInterval.range.high.value = 42
* qualifiedInterval.range.extension[ScoreHealthCorrelation].valueCodeableConcept.coding = http://terminology.hl7.org/CodeSystem/measure-improvement-notation#decrease
* qualifiedInterval.range.extension[ScoreHealthCorrelation].valueCodeableConcept.text = "Higher score indicates worse anxiety severity (DASS-42 equivalent = DASS-21 raw x 2)"
...
InstanceOf: mii-pr-pro-score-blueprint
Title: "DASS-21 Stress Score (DASS-42 Equivalent)"
...
* qualifiedInterval.range.high.value = 42
* qualifiedInterval.range.extension[ScoreHealthCorrelation].valueCodeableConcept.coding = http://terminology.hl7.org/CodeSystem/measure-improvement-notation#decrease
* qualifiedInterval.range.extension[ScoreHealthCorrelation].valueCodeableConcept.text = "Higher score indicates worse stress severity (DASS-42 equivalent = DASS-21 raw x 2)"
