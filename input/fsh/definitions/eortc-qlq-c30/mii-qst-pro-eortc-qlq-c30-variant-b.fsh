Instance: mii-qst-pro-eortc-qlq-c30-variant-b
...
* contained[+] = eortc-qlq-c30-cs-b

// ===== CONTAINED VALUESETS (referencing local CodeSystem) =====
* contained[+] = eortc-qlq-c30-4pt-b
* contained[+] = eortc-qlq-c30-7pt-b
...
* item[=].answerValueSet = "#eortc-qlq-c30-4pt-b"
...
* item[=].answerValueSet = "#eortc-qlq-c30-7pt-b"
...
// ===== CONTAINED VALUESET INSTANCES (referencing local CodeSystem via #) =====
