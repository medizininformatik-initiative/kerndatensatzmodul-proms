...
Alias: $mii-qst-pro-wi-7 = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/Questionnaire/mii-qst-pro-wi-7
Alias: $mii-qst-pro-pc-ptsd = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/Questionnaire/mii-qst-pro-pc-ptsd
Alias: $mii-qst-pro-ssd-12 = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/Questionnaire/mii-qst-pro-ssd-12
Alias: $mii-qst-pro-isr-z = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/Questionnaire/mii-qst-pro-isr-z
Alias: $mii-qst-pro-euronet-soma = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/Questionnaire/mii-qst-pro-euronet-soma
Alias: $mii-cs-pro-ssd-12-answers = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/CodeSystem/mii-cs-pro-ssd-12-answers
Alias: $mii-cs-pro-isr-z-answers = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/CodeSystem/mii-cs-pro-isr-z-answers
Alias: $mii-qst-pro-gad-7 = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/Questionnaire/mii-qst-pro-gad-7
Alias: $mii-qst-pro-scoff = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/Questionnaire/mii-qst-pro-scoff
Alias: $mii-qst-pro-phq-15 = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/Questionnaire/mii-qst-pro-phq-15
Alias: $mii-cs-pro-phq-15-answers = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/CodeSystem/mii-cs-pro-phq-15-answers
Alias: $mii-vs-pro-phq-15-answers = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/ValueSet/mii-vs-pro-phq-15-answers
...
Alias: $mii-cs-pro-score-catalogue = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/CodeSystem/mii-cs-pro-score-catalogue
Alias: $mii-cs-pro-questionnaire-catalogue = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/CodeSystem/mii-cs-pro-questionnaire-catalogue
Alias: $mii-qst-pro-bdi-bdi2 = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/Questionnaire/mii-qst-pro-bdi-bdi2
Alias: $mii-cs-pro-bdi-bdi2 = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/CodeSystem/mii-cs-pro-bdi-bdi2
Alias: $mii-qst-pro-promis-depression-sf4a = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/Questionnaire/mii-qst-pro-promis-depression-sf4a
...
Alias: $hl7-item-weight = http://hl7.org/fhir/StructureDefinition/itemWeight
Alias: $hl7-questionnaire-hidden = http://hl7.org/fhir/StructureDefinition/questionnaire-hidden
Alias: $hl7-questionnaire-option-prefix = http://hl7.org/fhir/StructureDefinition/questionnaire-optionPrefix
...
Alias: $sdc-questionnaire-display-category = http://hl7.org/fhir/questionnaire-display-category
Alias: $sdc-questionnaire-display-category-ex = http://hl7.org/fhir/StructureDefinition/questionnaire-displayCategory
Alias: $sdc-questionnaire-entry-format = http://hl7.org/fhir/StructureDefinition/entryFormat
Alias: $sdc-questionnaire-item-control = http://hl7.org/fhir/questionnaire-item-control
