...
Alias: $mii-cs-pro-yes-no-answers = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/CodeSystem/mii-cs-pro-yes-no-answers
Alias: $mii-vs-pro-yes-no-answers = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/ValueSet/mii-vs-pro-yes-no-answers
