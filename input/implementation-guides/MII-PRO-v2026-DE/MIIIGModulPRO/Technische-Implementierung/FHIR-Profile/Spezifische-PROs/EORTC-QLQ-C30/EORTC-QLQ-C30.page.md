...
| Score-Bereich | Funktionsskalen | Symptomskalenen |
|---------------|------------------|------------------|
...
- **Antwortoptionen**: MII-kontrollierte CodeSystems mit `itemWeight`-Properties für Scoring

### CodeSystem & ValueSets
- **CodeSystem**: `mii-cs-pro-eortc-qlq-c30` - Multilingual response scales with German designations
- **ValueSets**: 
...
- Symptomskalenen: `mii-obsdef-pro-eortc-qlq-c30-fa`, `mii-obsdef-pro-eortc-qlq-c30-nv`, etc.
...
### EORTC-Richtlinien
- **≥50% der Items** einer Skala müssen beantwortet sein
- **Ersetzung** fehlender Werte durch Mittelwert der verfügbaren Items der Skala
- **Ausschluss** der Skala bei >50% fehlenden Werten
...
*Diese Implementierung folgt den MII-Terminologie-Strategien und verwendet MII-kontrollierte CodeSystems für zuverlässige Score-Berechnungen in deutschen Gesundheitsumgebungen.*