<!-- TODO:REVIEW machine translation of source page pc-ptsd.md (de) — template migration, Gate C; the authored text is input/translations/de/pagecontent/pc-ptsd.md -->
