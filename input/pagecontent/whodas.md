<!-- TODO:REVIEW machine translation of source page whodas.md (de) — template migration, Gate C; the authored text is input/translations/de/pagecontent/whodas.md -->
