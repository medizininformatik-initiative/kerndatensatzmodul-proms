...
- MII CodeSystem with itemWeight extensions for scoring

See the [Questionnaire definition](Questionnaire-mii-qst-pro-dass-dass21.html) for the full resource.
...
See the [CodeSystem definition](CodeSystem-mii-cs-pro-dass-21.html) for the full resource.

**ValueSet:** `mii-vs-pro-dass-21-answer-list` -- 4-point Likert response scale (0-3)

See the [ValueSet definition](ValueSet-mii-vs-pro-dass-21-answer-list.html) for the full resource.
...
2. **Nilges P, Essau C.** (2015)
   *Die Depressions-Angst-Stress-Skalen: Der DASS -- ein Screeninginstrument nicht nur fur Schmerzpatienten*
   Schmerz. 29(6):649-57
