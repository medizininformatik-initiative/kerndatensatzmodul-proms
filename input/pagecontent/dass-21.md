...
Die vollständige Ressource finden Sie in der [Questionnaire-Definition](Questionnaire-mii-qst-pro-dass-dass21.html).
...
Die vollständige Ressource finden Sie in der [CodeSystem-Definition](CodeSystem-mii-cs-pro-dass-21.html).

**ValueSet:** `mii-vs-pro-dass-21-answer-list` -- 4-Punkt-Likert-Antwortskala (0-3)

Die vollständige Ressource finden Sie in der [ValueSet-Definition](ValueSet-mii-vs-pro-dass-21-answer-list.html).
