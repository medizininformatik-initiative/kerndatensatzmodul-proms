...
<div style="text-align: center;">
{% include img.html img="Workflow_Capability-Echtzeit.svg" caption="MII PRO Workflow Pattern: Capability-Based Variant, Real-Time Calculation" width="40%" %}
</div>
...
<div style="text-align: center;">
{% include img.html img="Workflow_Capability-Server.svg" caption="MII PRO Workflow Pattern: Capability-Based Variant, Server-Side Calculation" width="50%" %}
</div>
...
<div style="text-align: center;">
{% include img.html img="Workflow_Capability-Historisch.svg" caption="MII PRO Workflow Pattern: Capability-Based Variant, Historical Recalculation" width="40%" %}
</div>
...
<div style="text-align: center;">
{% include img.html img="Workflow_Score_Repraesentation.svg" caption="MII PRO Workflow Pattern: Score Representation Layers" width="60%" %}
</div>
