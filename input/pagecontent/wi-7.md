<!-- TODO:REVIEW machine translation of source page wi-7.md (de) — template migration, Gate C; the authored text is input/translations/de/pagecontent/wi-7.md -->
...
- Score calculation via FHIRPath: `%resource.item.where(linkId.matches('^wi7-q0[1-7]$')).answer.value.weight().sum()`.
