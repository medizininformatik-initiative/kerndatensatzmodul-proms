# EURONET-SOMA - MII IG PRO v2027.0.0-ballot.rc5
...
1. the**interference**caused by those complaints over the same period
...
The complete resource: [Questionnaire definition](Questionnaire-mii-qst-pro-euronet-soma.md).
