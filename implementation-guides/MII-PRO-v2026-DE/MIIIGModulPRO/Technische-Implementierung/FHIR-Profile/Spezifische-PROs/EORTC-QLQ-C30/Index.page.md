...
Der EORTC QLQ-C30 ist primär für das MII Onkologie-Modul relevant. Weitere onkologie-spezifische PROs werden dort verwaltet.

### Roadmap

- **v0.2.0** (Q2 2025): Missing-Item-Handling
- **v0.3.0** (Q3 2025): Integration weitere QLQ-Module
- **v1.0.0** (2026): Produktionsreife mit Onkologie-Modul
